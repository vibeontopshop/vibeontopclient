  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 p-4">
      {products.map((product) => (
        <div key={product.id} className="relative w-full max-w-[372px] max-sm:max-w-full">
          <div className="absolute left-0 px-3 py-1.5 text-xl font-semibold leading-9 text-white bg-black top-[13px] z-10">
            -{product.discount}%
          </div>
          <div className="relative aspect-[0.77] w-full bg-neutral-100 overflow-hidden">
            <Image
              src={product.image}
              alt={product.name}
              fill
            ...
            />
            {product.inStock && (
              <div className="absolute bottom-0 left-0 mb-2 ml-2 flex items-center gap-1 p-2.5 rounded border-white border-solid bg-zinc-300 bg-opacity-50 border-[0.855px] shadow-[0_17.099px_44.705px_rgba(68,68,68,0.04),0_36.219px_26.181px_rgba(68,68,68,0.08)] z-10">
                <Image
