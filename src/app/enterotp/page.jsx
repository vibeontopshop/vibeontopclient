    ...
    <div className="flex min-h-screen flex-col lg:flex-row bg-gray-800 text-gray-800">
      ...
      <div className="lg:w-1/2 flex flex-col justify-center items-center p-8 bg-white">
        ...
        >
          ...
          <h1 className="text-4xl font-bold text-gray-900">Enter OTP</h1>
          <p className="mt-3 text-sm text-gray-800">We Have share a code of your registered email address </p>
          ...
          <form className="mt-6 space-y-4">
            ...
            <div className='flex gap-3'>
              ...
              <input
                ...
                // name="email"
                required
                className="w-14 h-35 px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
              />
              <input
                type="text"
                // id="email"
              ...
              />
               {/* <input
                ...
                name="email"
                required
                className="h-35 px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
              /> */}
            </div>
